...
void AP_Logger::Write_PSCx(LogMessages id, float pos_target, float pos, float vel_target, float vel, float accel_target, float accel, float user_time_diff, float user_target_diff)
{
    const struct log_PSCx pkt{
        LOG_PACKET_HEADER_INIT(id),
            ...
            user_target_diff    : user_target_diff
    };
    WriteBlock(&pkt, sizeof(pkt));
}

void AP_Logger::Write_PSCN(float pos_target, float pos, float vel_target, float vel, float accel_target, float accel, float user_time_diff, float user_target_diff)
{
    Write_PSCx(LOG_PSCN_MSG, pos_target, pos, vel_target, vel, accel_target, accel, user_time_diff, user_target_diff);
}

void AP_Logger::Write_PSCE(float pos_target, float pos, float vel_target, float vel, float accel_target, float accel, float user_time_diff, float user_target_diff)
{
    Write_PSCx(LOG_PSCE_MSG, pos_target, pos, vel_target, vel, accel_target, accel, user_time_diff, user_target_diff);
}

void AP_Logger::Write_PSCD(float pos_target, float pos, float vel_target, float vel, float accel_target, float accel, float user_time_diff, float user_target_diff)
{
    Write_PSCx(LOG_PSCD_MSG, pos_target, pos, vel_target, vel, accel_target, accel, user_time_diff, user_target_diff);
}
